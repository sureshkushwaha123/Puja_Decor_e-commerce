...
import home_decor_image from "./home_decor_image.png";
import home_furnishing_image from "./home_furnishing_image.png";
import gifts_festive_image from "./gifts_festive_image.png";
import hand_made_image from "./hand_made_image.png";
import fashion_accessories from "./fashion_accessories.png";
...
export const categories = [
  ...
  },
  {
    ...
    image: home_furnishing_image,
    bgColor: "#FEE0E0",
  },
  {
    text: "Fashion & Accessories",
    path: "Fashion-Accessories",
    image: fashion_accessories,
    bgColor: "#F0F5DE",
  },
  {
    text: "Gifts & Festive",
    path: "Gifts-Festive",
    image: gifts_festive_image,
    bgColor: "#E1F5EC",
  },
  {
    text: "Handcrafted Items",
    path: "Handcrafted-Items",
    image: hand_made_image,
    bgColor: "#FEE6CD",
  },
  {
    text: "Bakery & Breads",
...
export const footerLinks = [
  ...
  },
  {
    title: "Follow Us",
    links: [
      { text: "Instagram", url: "https://www.instagram.com/sureshkushwaha1430/" },
      { text: "Twitter", url: "#" },
      { text: "Facebook", url: "#" },
      { text: "YouTube", url: "#" },
    ],
...
export const features = [
  {
    ...
    description: "Your favorite décor and accessories delivered safely to your doorstep.",
  },
  {
    icon: leaf_icon,
    title: "Handcrafted & Unique",
    description: "Each piece is carefully made by skilled artisans — truly one of a kind.",
  },
  {
    icon: coin_icon,
    title: "Affordable Elegance",
    description: "Stylish home décor and fashion that fit your budget perfectly.",
  },
  {
    icon: trust_icon,
    title: "Trusted by Design Lovers",
    description: "Loved by thousands of happy customers who value quality and creativity.",
  },
];
